...
Foundation Individual Contributor License Agreement, a widely used
industry standard. By submitting a Contribution you accept these terms.
...
submit to the Project in any form (pull request, patch, issue text,
or otherwise).
...
derivative works, and to license your Contributions and such
derivative works under any license terms, including open source
licenses and commercial licenses. This is the clause that allows the
Project to remain dual-licensable; you keep full rights to use your
...
otherwise transfer your Contribution, where such license applies only
...
Contribution with the work to which it was submitted. If any entity
institutes patent litigation alleging that the Project or a
Contribution constitutes patent infringement, any patent licenses
...
licenses; that each Contribution is your original creation or that
you have identified any third-party material and its license within
the Contribution; and that, if your employer has rights to
intellectual property you create, you have received permission to
make the Contribution on behalf of that employer or your employer has
waived such rights.

## 5. No Warranty; No Obligation

You provide your Contributions "AS IS", without warranties or
conditions of any kind. You are not expected to provide support for
your Contributions. The Maintainer is under no obligation to accept
or use any Contribution.

## 6. How to Agree

Include the following line in the description of your first pull
request (or in a comment on it):
