...
operations across 67 tools, a lite core that opens at about 11,300 tokens,
...
- **Tiered loading: starts at about 11.3k tokens, scales to everything.** A
  ...
  the full surface measures about 19,700 tokens. All figures come from
...
| **Full surface** | **69** | **~19.7k** | Everything (67 workbook tools plus `enable_tools` / `disable_tools`) |
...
|---|---:|---:|---|
| Lite core | 40 | ~11.3k | From the first message of every session |
...
| Everything switched on | 69 | ~19.7k | `KS4XL_MODE=full`, if you want it all up front |
...
793 tests in `tests/unit`, plus a separate local COM gate battery that drives a
