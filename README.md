...
operations across 67 tools, a lite core that opens at about 13,800 tokens,
...
- **Tiered loading: starts at about 13.8k tokens, scales to everything.** A
...
|---|---:|---:|---|
| Lite core | 40 | ~13.8k | From the first message of every session |
| Design pack | 9 | ~4.0k | Only after `enable_tools` |
| Layout plus inspection pack (`io`) | 9 | ~2.6k | Only after `enable_tools` |
| COM pack | 11 | ~2.6k | Only after `enable_tools`, and only on Windows with Excel |
| Everything switched on | 69 | ~22.9k | `KS4XL_MODE=full`, if you want it all up front |
